 ...
 */
export function imagesCompleteUpload(
  client: SfcCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CompleteImageUploadRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/images/{id}/complete")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ImageUploadResponse$inboundSchema),
