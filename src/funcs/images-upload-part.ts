 ...
 */
export function imagesUploadPart(
  client: SfcCore,
  ...
  Result<
    models.VmorchUploadPartResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UploadPartRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/images/{id}/parts")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VmorchUploadPartResponse$inboundSchema),
