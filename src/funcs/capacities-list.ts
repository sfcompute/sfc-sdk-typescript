...
export function capacitiesList(
  ...
  Result<
    models.MarketApiListCapacitiesResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListCapacitiesHandlerRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v2/capacities")();
  ...
  const context = {
    ...
    operationID: "list_capacities_handler",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MarketApiListCapacitiesResponse$inboundSchema),
