...
import {
  MarketApiSide,
  MarketApiSide$inboundSchema,
} from "./market-api-side.js";
import {
  MarketApiV2OrderStatus,
  MarketApiV2OrderStatus$inboundSchema,
} from "./market-api-v2-order-status.js";

export type MarketApiV2OrderResponse = {
  object: "order";
  id: string;
  capacity: string;
  side: MarketApiSide;
...
/** @internal */
export const MarketApiV2OrderResponse$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    side: MarketApiSide$inboundSchema,
    ...
    status: MarketApiV2OrderStatus$inboundSchema,
...
export function marketApiV2OrderResponseFromJSON(
  jsonString: string,
): SafeParseResult<MarketApiV2OrderResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MarketApiV2OrderResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MarketApiV2OrderResponse' from JSON`,
  );
}
