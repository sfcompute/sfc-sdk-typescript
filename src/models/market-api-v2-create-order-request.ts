...
import {
  MarketApiSide,
  MarketApiSide$outboundSchema,
} from "./market-api-side.js";

export type MarketApiV2CreateOrderRequest = {
  /**
...
/** @internal */
export type MarketApiV2CreateOrderRequest$Outbound = {
  capacity: string;
  side: string;
...
/** @internal */
export const MarketApiV2CreateOrderRequest$outboundSchema: z.ZodMiniType<
  MarketApiV2CreateOrderRequest$Outbound,
  MarketApiV2CreateOrderRequest
> = z.pipe(
  z.object({
    capacity: z.string(),
    side: MarketApiSide$outboundSchema,
...
export function marketApiV2CreateOrderRequestToJSON(
  marketApiV2CreateOrderRequest: MarketApiV2CreateOrderRequest,
): string {
  return JSON.stringify(
    MarketApiV2CreateOrderRequest$outboundSchema.parse(
      marketApiV2CreateOrderRequest,
    ),
  );
}
