...
/** @internal */
export type PatchCapacityRequest$Outbound = {
  name?: string | null | undefined;
  zones?: Array<string> | null | undefined;
...
/** @internal */
export const PatchCapacityRequest$outboundSchema: z.ZodMiniType<
  PatchCapacityRequest$Outbound,
...
export function patchCapacityRequestToJSON(
  patchCapacityRequest: PatchCapacityRequest,
): string {
  return JSON.stringify(
    PatchCapacityRequest$outboundSchema.parse(patchCapacityRequest),
  );
}
