...
| `side`                                                     | [models.Side](../../models/side.md)                        | :heavy_minus_sign:                                         | N/A                                                        |                                                            |
| `status`                                                   | [models.V2OrderStatus](../../models/v2-order-status.md)[]  | :heavy_minus_sign:                                         | Filter by status (repeatable).                             |                                                            |
