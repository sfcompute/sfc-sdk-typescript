...
| `nodeTemplate`                                                                                         | *string*                                                                                               | :heavy_minus_sign:                                                                                     | An ID _or_ name identifying this resource.                                                             | ntmpl_k3R-nX9vLm7Qp2Yw5Jd8F                                                                            |
...
| `scheduler`                                                                                            | *models.SchedulerDetailsInputUnion*                                                                    | :heavy_minus_sign:                                                                                     | Schedulers automatically place buy and sell orders to attempt to achieve desired compute availability. |                                                                                                        |